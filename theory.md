...
voltage to start. It requires several hundreds of volts ( v).
...
high voltage surge across the two filaments
...
reverts back to its normal position causing the switch contacts to open.
